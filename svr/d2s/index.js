...
function read(buffer, constants, version) {
    return __awaiter(this, void 0, void 0, function () {
        var stash, reader, pageCount, saveVersion, saveVersion, stashItems, i, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    stash = { pages: [] };
                    ...
                    reader.SeekByte(0);
                    if (!(stash.type === types.EStashType.D2R)) return [3 /*break*/, 5];
                    pageCount = 0;
                    _c.label = 1;
                case 1:
                    if (!(reader.offset < reader.bits.length)) return [3 /*break*/, 4];
                    pageCount++;
                    return [4 /*yield*/, readStashMeta(stash, reader)];
                case 2:
                    _c.sent();
                ...
                case 4:
                    ...
                    return [3 /*break*/, 13];
                case 5: return [4 /*yield*/, readStashMeta(stash, reader)];
                case 6:
                    _c.sent();
                    saveVersion = version || parseInt(stash.version);
                    if (!constants) {
                    ...
                    if (!(stash.type === types.EStashType.SSS || stash.type === types.EStashType.CSTM)) return [3 /*break*/, 8];
                    return [4 /*yield*/, readStashPages(stash, reader, saveVersion, constants)];
                case 7:
                    _c.sent();
                    return [3 /*break*/, 13];
                case 8:
                    if (!(stash.type === types.EStashType.D2X)) return [3 /*break*/, 13];
                    stashItems = [];
                    reader.SeekByte(11);
                    i = 0;
                    _c.label = 9;
                case 9:
                    if (!(i < stash.itemCount)) return [3 /*break*/, 12];
                    _b = (_a = stashItems).push;
                    return [4 /*yield*/, items.readItem(reader, saveVersion, constants, {})];
                case 10:
                    _b.apply(_a, [_c.sent()]);
                    _c.label = 11;
                case 11:
                    ...
                    return [3 /*break*/, 9];
                case 12:
                    stash.pages.push({ items: stashItems });
                    _c.label = 13;
                case 13: return [2 /*return*/, stash];
            }
        });
    });
}
exports.read = read;
function readStashHeader(reader) {
    reader.SeekBit(0);
    var header32 = reader.ReadUInt32();
    // Resurrected
    ...
    // Check 24 bit header
    reader.SeekBit(0);
    var header24 = reader.ReadUInt32(24);
    // D2X (Atma/GoMule)
    if (header24 === 0x583244) {
        return types.EStashType.D2X;
    }
    var header24Hex = header24 === null || header24 === void 0 ? void 0 : header24.toString(16);
    var header32Hex = header32 === null || header32 === void 0 ? void 0 : header32.toString(16);
    throw new Error("unknown stash header at position 0: 24bit = 0x" + header24Hex + ", 32bit = 0x" + header32Hex);
}
function readStashMeta(stash, reader) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    if (!(data.type === types.EStashType.D2R)) return [3 /*break*/, 5];
                    _i = 0, _a = data.pages;
                    _h.label = 1;
                case 1:
                ...
                case 5:
                    if (!(data.type === types.EStashType.SSS || data.type === types.EStashType.CSTM)) return [3 /*break*/, 8];
                ...
                case 7:
                    ...
                    return [3 /*break*/, 9];
                case 8:
                    if (data.type === types.EStashType.D2X) {
                        throw new Error('No write support for D2X (Atma/GoMule)');
                    }
                    _h.label = 9;
                case 9: return [2 /*return*/, writer.ToArray()];
            }
        });
    });
}
...
var EStashType;
(function (EStashType) {
    EStashType[EStashType["D2R"] = 0] = "D2R";
    EStashType[EStashType["SSS"] = 1] = "SSS";
    EStashType[EStashType["CSTM"] = 2] = "CSTM";
    EStashType[EStashType["D2X"] = 3] = "D2X";
...
Object.defineProperty(exports, "readStash", { enumerable: true, get: function () { return stash_1.read; } });
Object.defineProperty(exports, "writeStash", { enumerable: true, get: function () { return stash_1.write; } });
